...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //设置json默认类型
    ATHttpClient.client.jsonModelClass = API_ResponseModel.class;
    
    //这里处理manager
    ATHttpClient.client.globalSessionManagerInterceptor = ^AFHTTPSessionManager * _Nonnull(AFHTTPSessionManager * _Nonnull manager, ATHttpRequest * _Nonnull req) {
    ...
    ATHttpClient.client.globalRequestInterceptor = ^(AFHTTPSessionManager * _Nonnull manager, ATHttpRequest * _Nonnull req) {
    ...
    ATHttpClient.client.globalRequestRetryInterceptor = ^(ATHttpRequest * _Nonnull req) {
    ...
    ATHttpClient.client.globalResponseSuccessInterceptor = ^BOOL(ATHttpRequest * _Nonnull req, NSURLSessionDataTask * _Nullable task, id  _Nullable resp, NSError * _Nullable error) {
    ...
    ATHttpClient.client.globalResponseFailureInterceptor = ^BOOL(ATHttpRequest * _Nonnull req, NSURLSessionDataTask * _Nullable task, id  _Nullable resp, NSError * _Nullable error) {
        NSDictionary * respHeader = ((NSHTTPURLResponse *)task.response).allHeaderFields;
